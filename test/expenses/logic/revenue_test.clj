...
(facts "Getting data for given month and year"
  (fact "should return total adding current active revenue to Inactive revenue and other for month "
    (logic.revenue/data-for-month-year
      {:month "Fev" :month-value 2} "2020" recurrent-active recurrent-inactive other-revenue) => {:title "Fev" :amount 7600.0})
  (fact "testing 2"
    (logic.revenue/data-for-month-year
      {:month "Apr" :month-value 4} "2020" recurrent-active recurrent-inactive other-revenue) => {:title "Apr" :amount 7800.0})
  (fact "testing 3"
    (logic.revenue/data-for-month-year
      {:month "May" :month-value 5} "2019" recurrent-active recurrent-inactive []) => {:title "May" :amount 2200.0}))
